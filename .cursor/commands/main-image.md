Make this image JPEG format at 65% quality (to match other optimized JPEGs), a consistent file size to the other files, and 4:3 ratio (4 being the height), using minimal cropping.
...
- The command structure should be: `magick [input] -auto-orient [crop/resize operations] -strip -quality 65 [output].jpg`
